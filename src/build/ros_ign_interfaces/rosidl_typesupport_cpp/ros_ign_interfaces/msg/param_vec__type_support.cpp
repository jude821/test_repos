...
static const _ParamVec_type_support_symbol_names_t _ParamVec_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_ign_interfaces, msg, ParamVec)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_ign_interfaces, msg, ParamVec)),
  }
};
...
{
  return &::ros_ign_interfaces::msg::rosidl_typesupport_cpp::ParamVec_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros_ign_interfaces, msg, ParamVec)() {
  return get_message_type_support_handle<ros_ign_interfaces::msg::ParamVec>();
}
