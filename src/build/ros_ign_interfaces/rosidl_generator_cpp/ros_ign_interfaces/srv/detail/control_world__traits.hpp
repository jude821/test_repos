...
[[deprecated("use ros_ign_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ros_ign_interfaces::srv::ControlWorld_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  ros_ign_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use ros_ign_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const ros_ign_interfaces::srv::ControlWorld_Request & msg)
{
  return ros_ign_interfaces::srv::to_yaml(msg);
}
