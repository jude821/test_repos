...
#include "ros_ign_interfaces/msg/detail/track_visual__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_ign_interfaces::msg::TrackVisual & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_ign_interfaces::msg::TrackVisual & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const ros_ign_interfaces::msg::TrackVisual *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_ign_interfaces::msg::TrackVisual *>(
    untyped_ros_message);
...
get_message_type_support_handle<ros_ign_interfaces::msg::TrackVisual>()
{
  return &ros_ign_interfaces::msg::typesupport_fastrtps_cpp::_TrackVisual__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_ign_interfaces, msg, TrackVisual)() {
  return &ros_ign_interfaces::msg::typesupport_fastrtps_cpp::_TrackVisual__handle;
}
