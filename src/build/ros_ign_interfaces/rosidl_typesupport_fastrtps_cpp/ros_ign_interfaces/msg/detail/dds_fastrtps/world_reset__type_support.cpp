...
#include "ros_ign_interfaces/msg/detail/world_reset__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_ign_interfaces::msg::WorldReset & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_ign_interfaces::msg::WorldReset & ros_message)
{
  // Member: all
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const ros_ign_interfaces::msg::WorldReset *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_ign_interfaces::msg::WorldReset *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WorldReset__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ros_ign_interfaces::msg::WorldReset *>(
...
static size_t _WorldReset__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_WorldReset(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _WorldReset__callbacks = {
...
static rosidl_message_type_support_t _WorldReset__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WorldReset__callbacks,
...
get_message_type_support_handle<ros_ign_interfaces::msg::WorldReset>()
{
  return &ros_ign_interfaces::msg::typesupport_fastrtps_cpp::_WorldReset__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_ign_interfaces, msg, WorldReset)() {
  return &ros_ign_interfaces::msg::typesupport_fastrtps_cpp::_WorldReset__handle;
}
