...
#include "ros_ign_interfaces/msg/detail/entity__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_ign_interfaces::msg::Entity & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_ign_interfaces::msg::Entity & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
{
  auto typed_message =
    static_cast<const ros_ign_interfaces::msg::Entity *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_ign_interfaces::msg::Entity *>(
    untyped_ros_message);
...
{
  return &ros_ign_interfaces::msg::typesupport_fastrtps_cpp::_Entity__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_ign_interfaces, msg, Entity)() {
  return &ros_ign_interfaces::msg::typesupport_fastrtps_cpp::_Entity__handle;
}
