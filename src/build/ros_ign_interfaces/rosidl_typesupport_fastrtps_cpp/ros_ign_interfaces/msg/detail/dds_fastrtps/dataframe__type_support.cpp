...
#include "ros_ign_interfaces/msg/detail/dataframe__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_ign_interfaces::msg::Dataframe & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: src_address
  cdr << ros_message.src_address;
  // Member: dst_address
  cdr << ros_message.dst_address;
  // Member: data
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_ign_interfaces::msg::Dataframe & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const ros_ign_interfaces::msg::Dataframe *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_ign_interfaces::msg::Dataframe *>(
    untyped_ros_message);
...
static size_t _Dataframe__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Dataframe(full_bounded, is_plain, 0);
...
{
  return &ros_ign_interfaces::msg::typesupport_fastrtps_cpp::_Dataframe__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_ign_interfaces, msg, Dataframe)() {
  return &ros_ign_interfaces::msg::typesupport_fastrtps_cpp::_Dataframe__handle;
}
