...
ros_ign_interfaces__srv__DeleteEntity_Request__create()
{
  ...
  ros_ign_interfaces__srv__DeleteEntity_Request * msg = (ros_ign_interfaces__srv__DeleteEntity_Request *)allocator.allocate(sizeof(ros_ign_interfaces__srv__DeleteEntity_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
ros_ign_interfaces__srv__DeleteEntity_Request__Sequence__init(ros_ign_interfaces__srv__DeleteEntity_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ros_ign_interfaces__srv__DeleteEntity_Request *)allocator.zero_allocate(size, sizeof(ros_ign_interfaces__srv__DeleteEntity_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_ign_interfaces__srv__DeleteEntity_Request__Sequence * array = (ros_ign_interfaces__srv__DeleteEntity_Request__Sequence *)allocator.allocate(sizeof(ros_ign_interfaces__srv__DeleteEntity_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  ros_ign_interfaces__srv__DeleteEntity_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ros_ign_interfaces__srv__DeleteEntity_Request * data =
      (ros_ign_interfaces__srv__DeleteEntity_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros_ign_interfaces__srv__DeleteEntity_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros_ign_interfaces__srv__DeleteEntity_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_ign_interfaces__srv__DeleteEntity_Response * msg = (ros_ign_interfaces__srv__DeleteEntity_Response *)allocator.allocate(sizeof(ros_ign_interfaces__srv__DeleteEntity_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
ros_ign_interfaces__srv__DeleteEntity_Response__Sequence__init(ros_ign_interfaces__srv__DeleteEntity_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ros_ign_interfaces__srv__DeleteEntity_Response *)allocator.zero_allocate(size, sizeof(ros_ign_interfaces__srv__DeleteEntity_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros_ign_interfaces__srv__DeleteEntity_Response__Sequence * array = (ros_ign_interfaces__srv__DeleteEntity_Response__Sequence *)allocator.allocate(sizeof(ros_ign_interfaces__srv__DeleteEntity_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  ros_ign_interfaces__srv__DeleteEntity_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ros_ign_interfaces__srv__DeleteEntity_Response * data =
      (ros_ign_interfaces__srv__DeleteEntity_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros_ign_interfaces__srv__DeleteEntity_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros_ign_interfaces__srv__DeleteEntity_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
