...
bool ros_ign_interfaces__msg__param_vec__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_ign_interfaces.msg._param_vec.ParamVec", full_classname_dest, 42) == 0);
  }
  ros_ign_interfaces__msg__ParamVec * ros_message = _ros_message;
  {  // header
  ...
  {  // params
    ...
    rcl_interfaces__msg__Parameter * dest = ros_message->params.data;
...
{
  /* NOTE(esteve): Call constructor of ParamVec */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_ign_interfaces.msg._param_vec");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ParamVec");
