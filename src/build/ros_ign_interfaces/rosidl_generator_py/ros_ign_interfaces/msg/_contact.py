...
class Metaclass_Contact(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros_ign_interfaces.msg import JointWrench
...
class Contact(metaclass=Metaclass_Contact):
    ...
    _fields_and_field_types = {
        'collision1': 'ros_ign_interfaces/Entity',
        'collision2': 'ros_ign_interfaces/Entity',
        'positions': 'sequence<geometry_msgs/Vector3>',
        'normals': 'sequence<geometry_msgs/Vector3>',
        'depths': 'sequence<double>',
        'wrenches': 'sequence<ros_ign_interfaces/JointWrench>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ros_ign_interfaces', 'msg'], 'JointWrench')),  # noqa: E501
    )
