...
class Metaclass_WorldControl(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros_ign_interfaces.msg import WorldReset
...
class WorldControl(metaclass=Metaclass_WorldControl):
    ...
    _fields_and_field_types = {
        ...
        'step': 'boolean',
        'multi_step': 'uint32',
        'reset': 'ros_ign_interfaces/WorldReset',
        'seed': 'uint32',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['ros_ign_interfaces', 'msg'], 'WorldReset'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint32'),  # noqa: E501
