...
class Metaclass_SpawnEntity_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros_ign_interfaces.msg import EntityFactory
...
class SpawnEntity_Request(metaclass=Metaclass_SpawnEntity_Request):
    ...
    _fields_and_field_types = {
        'entity_factory': 'ros_ign_interfaces/EntityFactory',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['ros_ign_interfaces', 'msg'], 'EntityFactory'),  # noqa: E501
    )
...
class Metaclass_SpawnEntity(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros_ign_interfaces.srv import _spawn_entity
...
class SpawnEntity(metaclass=Metaclass_SpawnEntity):
    from ros_ign_interfaces.srv._spawn_entity import SpawnEntity_Request as Request
    from ros_ign_interfaces.srv._spawn_entity import SpawnEntity_Response as Response
