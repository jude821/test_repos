...
class Metaclass_SetEntityPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ros_ign_interfaces.srv import _set_entity_pose
...
class SetEntityPose(metaclass=Metaclass_SetEntityPose):
    from ros_ign_interfaces.srv._set_entity_pose import SetEntityPose_Request as Request
    from ros_ign_interfaces.srv._set_entity_pose import SetEntityPose_Response as Response
