...
{
  new (message_memory) ros_ign_interfaces::msg::Contacts(_init);
}

void Contacts_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros_ign_interfaces::msg::Contacts *>(message_memory);
  typed_message->~Contacts();
}

size_t size_function__Contacts__contacts(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<ros_ign_interfaces::msg::Contact> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<ros_ign_interfaces::msg::Contact> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<ros_ign_interfaces::msg::Contact> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const ros_ign_interfaces::msg::Contact *>(
    get_const_function__Contacts__contacts(untyped_member, index));
  auto & value = *reinterpret_cast<ros_ign_interfaces::msg::Contact *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<ros_ign_interfaces::msg::Contact *>(
    get_function__Contacts__contacts(untyped_member, index));
  const auto & value = *reinterpret_cast<const ros_ign_interfaces::msg::Contact *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Contacts_message_member_array[2] = {
  {
    ...
    offsetof(ros_ign_interfaces::msg::Contacts, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<ros_ign_interfaces::msg::Contact>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(ros_ign_interfaces::msg::Contacts, contacts),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Contacts_message_members = {
  ...
  2,  // number of fields
  sizeof(ros_ign_interfaces::msg::Contacts),
...
get_message_type_support_handle<ros_ign_interfaces::msg::Contacts>()
{
  return &::ros_ign_interfaces::msg::rosidl_typesupport_introspection_cpp::Contacts_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_ign_interfaces, msg, Contacts)() {
  return &::ros_ign_interfaces::msg::rosidl_typesupport_introspection_cpp::Contacts_message_type_support_handle;
}
