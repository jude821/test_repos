...
{
  new (message_memory) ros_ign_interfaces::msg::ParamVec(_init);
}

void ParamVec_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros_ign_interfaces::msg::ParamVec *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ParamVec_message_member_array[2] = {
  {
    ...
    offsetof(ros_ign_interfaces::msg::ParamVec, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_ign_interfaces::msg::ParamVec, params),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ParamVec_message_members = {
  ...
  2,  // number of fields
  sizeof(ros_ign_interfaces::msg::ParamVec),
...
{
  return &::ros_ign_interfaces::msg::rosidl_typesupport_introspection_cpp::ParamVec_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_ign_interfaces, msg, ParamVec)() {
  return &::ros_ign_interfaces::msg::rosidl_typesupport_introspection_cpp::ParamVec_message_type_support_handle;
}
