...
void fetch_function__Contact__wrenches(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const ros_ign_interfaces::msg::JointWrench *>(
    get_const_function__Contact__wrenches(untyped_member, index));
  auto & value = *reinterpret_cast<ros_ign_interfaces::msg::JointWrench *>(untyped_value);
  value = item;
}
...
void assign_function__Contact__wrenches(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<ros_ign_interfaces::msg::JointWrench *>(
    get_function__Contact__wrenches(untyped_member, index));
  const auto & value = *reinterpret_cast<const ros_ign_interfaces::msg::JointWrench *>(untyped_value);
  item = value;
}
