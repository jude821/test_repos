...
#include "ros_ign_interfaces/msg/detail/world_reset__rosidl_typesupport_fastrtps_c.h"
...
using _WorldReset__ros_msg_type = ros_ign_interfaces__msg__WorldReset;
...
static uint32_t _WorldReset__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_ign_interfaces__msg__WorldReset(
...
static size_t _WorldReset__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_ign_interfaces__msg__WorldReset(
