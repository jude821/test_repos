...
#include "ros_ign_interfaces/msg/detail/contact__rosidl_typesupport_fastrtps_c.h"
...
#include "ros_ign_interfaces/msg/detail/entity__functions.h"  // collision1, collision2
#include "ros_ign_interfaces/msg/detail/joint_wrench__functions.h"  // wrenches
...
using _Contact__ros_msg_type = ros_ign_interfaces__msg__Contact;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: wrenches
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros_ign_interfaces, msg, JointWrench
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: wrenches
  {
    ...
    if (ros_message->wrenches.data) {
      ros_ign_interfaces__msg__JointWrench__Sequence__fini(&ros_message->wrenches);
    }
    if (!ros_ign_interfaces__msg__JointWrench__Sequence__init(&ros_message->wrenches, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name wrenches
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ros_ign_interfaces__msg__JointWrench(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _Contact__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_ign_interfaces__msg__Contact(
  ...
  size_t current_alignment)
{
  ...
  // member: wrenches
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_ros_ign_interfaces__msg__JointWrench(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _Contact__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_ign_interfaces__msg__Contact(
