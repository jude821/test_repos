...
#include "ros_ign_interfaces/msg/detail/track_visual__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // xyz
...
using _TrackVisual__ros_msg_type = ros_ign_interfaces__msg__TrackVisual;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrackVisual__ros_msg_type * ros_message = static_cast<const _TrackVisual__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: inherit_orientation
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrackVisual__ros_msg_type * ros_message = static_cast<_TrackVisual__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _TrackVisual__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_ign_interfaces__msg__TrackVisual(
...
static size_t _TrackVisual__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_ign_interfaces__msg__TrackVisual(
...
static message_type_support_callbacks_t __callbacks_TrackVisual = {
...
static rosidl_message_type_support_t _TrackVisual__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrackVisual,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, msg, TrackVisual)() {
  return &_TrackVisual__type_support;
}
