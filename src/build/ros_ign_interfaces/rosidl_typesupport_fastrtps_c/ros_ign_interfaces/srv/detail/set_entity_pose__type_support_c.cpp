...
#include "ros_ign_interfaces/srv/detail/set_entity_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "ros_ign_interfaces/msg/detail/entity__functions.h"  // entity
...
using _SetEntityPose_Request__ros_msg_type = ros_ign_interfaces__srv__SetEntityPose_Request;
  ...
  // Field name: entity
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros_ign_interfaces, msg, Entity
      )()->data);
...
size_t get_serialized_size_ros_ign_interfaces__srv__SetEntityPose_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetEntityPose_Request__ros_msg_type * ros_message = static_cast<const _SetEntityPose_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_ros_ign_interfaces__msg__Entity(
...
static uint32_t _SetEntityPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_ign_interfaces__srv__SetEntityPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_ign_interfaces
size_t max_serialized_size_ros_ign_interfaces__srv__SetEntityPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: entity
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_ros_ign_interfaces__msg__Entity(
...
static size_t _SetEntityPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_ign_interfaces__srv__SetEntityPose_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, srv, SetEntityPose_Request)() {
...
using _SetEntityPose_Response__ros_msg_type = ros_ign_interfaces__srv__SetEntityPose_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_ign_interfaces
size_t get_serialized_size_ros_ign_interfaces__srv__SetEntityPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetEntityPose_Response__ros_msg_type * ros_message = static_cast<const _SetEntityPose_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_ign_interfaces__srv__SetEntityPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_ign_interfaces
size_t max_serialized_size_ros_ign_interfaces__srv__SetEntityPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _SetEntityPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_ign_interfaces__srv__SetEntityPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, srv, SetEntityPose_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_ign_interfaces, srv, SetEntityPose)() {
